...
router.put("/api/sub-category/update/:id",authMiddleware,updateSubCategoryController)
router.put("/api/sub-category/delete/:id",authMiddleware,deleteSubCategoryController)
